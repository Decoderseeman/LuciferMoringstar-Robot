...
# ---------- 📁 [ | 𝗚𝗘𝗧 𝗙𝗜𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            try:
                if FORCES_SUB and not await is_subscribed(client, query):
                    ...
                    await query.answer('🤖 Check PM, ❣️ Param Sundari ❣️ Had Sended The  Files In Pm 🤖',show_alert = True)
...
# ---------- 📁 [ | 𝗣𝗠 𝗙𝗜𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            for files in filedetails:
                ...
                buttons = [[
                  InlineKeyboardButton('🧑‍💻 How To Own 🧑‍💻', url='https://t.me/mastertheblasterr')
                  ]]                 
...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton("🗳 Deploy", url="https://t.me/mkv_rockers"),
                 InlineKeyboardButton("🤖 Update", url="https://t.me/mkvrequestroom")
                 ]]
            else:
                buttons = [[
                 InlineKeyboardButton("➕️ Add me to Your Chat ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
